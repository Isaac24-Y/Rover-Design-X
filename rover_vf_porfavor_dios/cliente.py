...
class RoverClienteUI:
    ...
    def crear_interfaz(self):
        ...
        self.odom_label = tk.Label(map_frame, 
                                   ...
                                   bg="#3d3d3d", fg="#00ff00", 
                                   font=("Arial", 9, "bold"))
        self.odom_label.pack(pady=3)
        
        tk.Button(map_frame, text="🔄 Reset Odometría", 
        ...
        # Estado
        estado_frame = tk.LabelFrame(control_frame, text="🤖 Estado", 
                                     bg="#3d3d3d", fg="white", font=("Arial", 10, "bold"))
        estado_frame.pack(fill="x", padx=5, pady=3)
        ...
        # Velocidad
        vel_frame = tk.LabelFrame(control_frame, text="⚡ Velocidad", 
                                  bg="#3d3d3d", fg="white", font=("Arial", 10, "bold"))
        vel_frame.pack(fill="x", padx=5, pady=3)
        ...
        self.vel_slider = tk.Scale(vel_frame, from_=0, to=255, orient="horizontal",
                                   ...
                                   command=self.velocidad_changed, length=180)
        ...
        self.servo3_slider = tk.Scale(servo_frame, from_=0, to=30, orient="horizontal",
                                      bg="#3d3d3d", fg="white", troughcolor="#1e1e1e",
                                      command=self.servo3_changed, length=180)
        ...
        self.servo4_slider = tk.Scale(servo_frame, from_=0, to=180, orient="horizontal",
                                      bg="#3d3d3d", fg="white", troughcolor="#1e1e1e",
                                      command=self.servo4_changed, length=180)
        self.servo4_slider.set(90)
        self.servo4_slider.pack(padx=5, pady=1)
        
        # Movimiento
        mov_frame = tk.LabelFrame(control_frame, text="🕹️ Movimiento (WASD/Flechas)", 
                                  bg="#3d3d3d", fg="white", font=("Arial", 10, "bold"))
        mov_frame.pack(fill="x", padx=5, pady=3)
        ...
        # Captura
        captura_frame = tk.LabelFrame(control_frame, text="📸 Captura", 
                                      bg="#3d3d3d", fg="white", font=("Arial", 10, "bold"))
        ...
        # Salir
        tk.Button(control_frame, text="✖ SALIR", command=self.cerrar,
    ...
    def tecla_presionada(self, event):
        ...
        # Si ya hay una tecla activa, ignorar nuevas teclas
    ...
    def tecla_liberada(self, event):
        ...
        # Solo detener si la tecla liberada es la activa
    ...
    def actualizar_gui(self):
        ...
        # Calcular tamaño de video adaptable
        video_width = min(480, int(self.root.winfo_width() * 0.3))
